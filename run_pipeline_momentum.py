...
brand_name = 'Momentum'
brand_overview = '''Momentum Devices crafts premium smartphones for the creators, innovators, and everyday adventurers who demand seamless performance and exceptional creative tools. Our flagship 'Kinetic' series is engineered with cutting-edge processing power, industry-leading camera systems co-developed with renowned lens makers, and stunningly fluid displays that bring your content to life. Momentum's proprietary 'FlowOS' offers an intuitive, bloatware-free experience, prioritizing speed, security, and deep integration with popular creative suites and cloud services. We believe your device should be an extension of your ambition, empowering you to capture, create, and connect without limits. With Momentum Devices, keep your world moving forward.'''
...
conv_lang = 'German' # For K_simulate_conversations
